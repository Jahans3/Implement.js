...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Interface__ = __webpack_require__(4);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Interface__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__errors__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["a"] = ((type, shape) => {
  ...
  if (validType === 'array') {
    const invalidElement = Array.isArray(shape) && shape.find(t => (!t[__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* IMPLEMENTS_TYPES */].TYPE] && !t[__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* IMPLEMENTS_TYPES */].INTERFACE]))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_warning__ = __webpack_require__(11);
...
const invalidTypeError = new (function () {
  ...
  `)
  this.warn = ({ type }) => {
    __WEBPACK_IMPORTED_MODULE_1_warning___default()(false, this.message({ type }))
  }
  this.throw = ({ type }) => {
    __WEBPACK_IMPORTED_MODULE_0_invariant___default()(false, this.message({ type }))
  }
...
const invalidArrayElementError = new (function () {
  ...
  `)
  this.warn = () => {
    __WEBPACK_IMPORTED_MODULE_1_warning___default()(false, this.message)
  }
  this.throw = () => {
    __WEBPACK_IMPORTED_MODULE_0_invariant___default()(false, this.message)
  }
